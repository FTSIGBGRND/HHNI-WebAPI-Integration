...
namespace FTSI_Web_API_System_Integration.Data
{
    public class FTDBWContext : DbContext
    {
        ...
        public DbSet<APDebitMemoHeader> FTORPC { get; set; }
        public DbSet<APDebitMemoLines> FTRPC1 { get; set; }
        public DbSet<APDebitMemoWTax> FTRPC5 { get; set; }
        #endregion
        ...
        #region Sales Order
        public DbSet<SalesOrderHeader> FTORDR { get; set; }
        public DbSet<SalesOrderLine> FTRDR1 { get; set; }
        #endregion
        ...
        #region Sales BOM
        public DbSet<ProductTree> FTOITT { get; set; }
        public DbSet<ProductTreeLine> FTITT1 { get; set; }
        #endregion
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // AP Credit Memo
            modelBuilder.Entity<APDebitMemoWTax>()
              .HasKey(l => new { l.Id, l.LineNum });

            modelBuilder.Entity<APDebitMemoLines>()
               .HasKey(l => new { l.Id, l.LineNum });
            ...
            // Sales BOM
            modelBuilder.Entity<ProductTreeLine>()
                .HasKey(l => new { l.Id, l.ChildNum });
        }
    }
}
