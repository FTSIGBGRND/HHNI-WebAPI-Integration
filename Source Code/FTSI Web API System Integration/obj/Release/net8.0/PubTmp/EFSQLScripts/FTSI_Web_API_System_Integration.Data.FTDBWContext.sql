...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20241209134740_UpdateDatabase') THEN
...
BEGIN
    ...
    CREATE TABLE `FTOCRD` (
        ...
        `Series` int NULL,
        `DebPayAcct` varchar(15) CHARACTER SET utf8mb4 NULL,
        `Currency` varchar(3) CHARACTER SET utf8mb4 NULL,
        `VatStatus` varchar(1) CHARACTER SET utf8mb4 NULL,
        ...
        `U_CompanyID` int NULL,
        `U_ChargeTo` varchar(15) CHARACTER SET utf8mb4 NULL,
        `U_LegalEntity` varchar(100) CHARACTER SET utf8mb4 NULL,
...
BEGIN
    ...
    CREATE TABLE `FTODPI` (
        ...
        `DocCur` varchar(3) CHARACTER SET utf8mb4 NULL,
        `DocRate` decimal(19,6) NULL,
...
BEGIN
    ...
    CREATE TABLE `FTOITM` (
        ...
        `ItmsGrpCod` int NULL,
        `UgpEntry` int NULL,
        `InvntItem` varchar(1) CHARACTER SET utf8mb4 NULL,
        `SellItem` varchar(1) CHARACTER SET utf8mb4 NULL,
        `PrchseItem` varchar(1) CHARACTER SET utf8mb4 NULL,
        `DfltWH` varchar(8) CHARACTER SET utf8mb4 NULL,
        `MngMethod` varchar(1) CHARACTER SET utf8mb4 NULL,
        `BuyUnitMsr` varchar(100) CHARACTER SET utf8mb4 NULL,
        `SalUnitMsr` varchar(100) CHARACTER SET utf8mb4 NULL,
        `InvntryUom` varchar(100) CHARACTER SET utf8mb4 NULL,
        `GLMethod` varchar(1) CHARACTER SET utf8mb4 NULL,
        `CreatedAt` datetime(6) NOT NULL,
        `U_RefNum` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
        `IntegrationStatus` varchar(1) CHARACTER SET utf8mb4 NULL,
        `IntegrationMessage` varchar(255) CHARACTER SET utf8mb4 NULL,
        `U_AssRes` varchar(20) CHARACTER SET utf8mb4 NULL,
        `U_Contract` varchar(30) CHARACTER SET utf8mb4 NULL,
        `U_ItemID` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_PackageID` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_ProcedureID` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_CustTag` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_Package` varchar(100) CHARACTER SET utf8mb4 NULL,
...
BEGIN
    ...
    CREATE TABLE `FTOITT` (
        ...
        `TreeType` varchar(1) CHARACTER SET utf8mb4 NULL,
        `CreatedAt` datetime(6) NOT NULL,
        `U_RefNum` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
        `IntegrationStatus` varchar(1) CHARACTER SET utf8mb4 NULL,
        `IntegrationMessage` varchar(255) CHARACTER SET utf8mb4 NULL,
        CONSTRAINT `PK_FTOITT` PRIMARY KEY (`Id`)
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `FTORDR` (
        ...
        `CancelDate` datetime(6) NULL,
        `CreatedAt` datetime(6) NOT NULL,
        CONSTRAINT `PK_FTORDR` PRIMARY KEY (`Id`)
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `FTDPI1` (
        ...
        `U_ArNo` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_NameOfCrew` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_Peme` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_Principal` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_Vessel` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_Age` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_Position` varchar(100) CHARACTER SET utf8mb4 NULL,
        `U_DiscType` varchar(15) CHARACTER SET utf8mb4 NULL,
        `BaseType` int NULL,
        `BaseEntry` int NULL,
        `BaseRef` int NULL,
        `BaseLine` int NULL,
...
BEGIN
    ...
    CREATE TABLE `FTITT1` (
        ...
        `Type` int NULL,
        `Quantity` decimal(19,6) NULL,
        `IssueMthd` varchar(1) CHARACTER SET utf8mb4 NULL,
        `Warehouse` varchar(8) CHARACTER SET utf8mb4 NULL,
        CONSTRAINT `PK_FTITT1` PRIMARY KEY (`Id`, `ChildNum`),
        CONSTRAINT `FK_FTITT1_FTOITT_Id` FOREIGN KEY (`Id`) REFERENCES `FTOITT` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE TABLE `FTRDR1` (
        ...
        `OcrCode5` varchar(8) CHARACTER SET utf8mb4 NULL,
        `CreatedAt` datetime(6) NOT NULL,
        CONSTRAINT `PK_FTRDR1` PRIMARY KEY (`Id`, `LineNum`),
        CONSTRAINT `FK_FTRDR1_FTORDR_Id` FOREIGN KEY (`Id`) REFERENCES `FTORDR` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE UNIQUE INDEX `IX_FTINV5_Id` ON `FTINV5` (`Id`);
...
BEGIN
    ...
    CREATE UNIQUE INDEX `IX_FTRIN5_Id` ON `FTRIN5` (`Id`);
...
BEGIN
    ...
    VALUES ('20241209134740_UpdateDatabase', '8.0.8');
