...
namespace FTSI_Web_API_System_Integration.Services
{
    public static class IServicesCollectionsExtension
    {
        ...
        public static void AddRepositoryServices(this IServiceCollection services)
        {
            ...
            services.AddTransient<IAPDebitMemoRepository, APDebitMemoRepository>();
            services.AddTransient<IRetirementRepository, RetirementRepository>();
            services.AddTransient<ISalesBomRepository, SalesBomRepository>();
        ...
        public static void AddSAPServices(this IServiceCollection services)
        {
            ...
            services.AddTransient<APDebitMemoService>();
            ...
            services.AddTransient<SalesBomService>();
            services.AddTransient<SalesOrderService>();
        }
